...
// .wrangler/tmp/bundle-d6HQrn/checked-fetch.js
...
__name(analyzeRequest, "analyzeRequest");
...
__name(generateRequirementDocument, "generateRequirementDocument");
function getRelatedSpecs(product) {
  const specs = {
...
__name(getRelatedSpecs, "getRelatedSpecs");
...
4. **\u7DCA\u6025\u5EA6**: \u5BFE\u5FDC\u306E\u512A\u5148\u5EA6\u3092\u6559\u3048\u3066\u304F\u3060\u3055\u3044\uFF08\u9AD8/\u4E2D/\u4F4E\uFF09`;
    ...
    if (eventType === "task.comment.created" || eventType === "comment.created") {
      ...
      console.log(`\u{1F4AC} \u30B3\u30E1\u30F3\u30C8\u53D7\u4FE1: ${commentContent}`);
      return c.json({
        success: true,
        message: "\u30B3\u30E1\u30F3\u30C8\u3092\u53D7\u4FE1\u3057\u307E\u3057\u305F",
        taskId
...
// .wrangler/tmp/bundle-d6HQrn/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-d6HQrn/middleware-loader.entry.ts
